...
public class GpsCorrectUtil {
    ...
    public static Map reverseLngLat(double lng, double lat, String key) throws Exception {
        String url = "https://restapi.amap.com/v3/geocode/regeo";
        URIBuilder builder = new URIBuilder(url);

        builder.setParameter("output", "json");
        builder.setParameter("key", key);
        builder.setParameter("location", lng + "," + lat);
        ...
        if (status == 1) {
            ...
            String city = (String) compoment.get("city");
